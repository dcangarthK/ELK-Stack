# Docker ELK stack
[https://github.com/deviantony/docker-elk/tree/x-pack](https://github.com/deviantony/docker-elk/tree/x-pack)
...
**Note**: need this to run Elasticsearch sudo sysctl -w vm.max_map_count=262144
